...
<a href="https://youtube.com/shorts/9fDdVvUkkM4" target="_blank">
  <img src="https://img.youtube.com/vi/9fDdVvUkkM4/maxresdefault.jpg" alt="Dashboard Demo" width="600" />
</a>
...
```bash
sudo cp /tmp/webfiles_backup_TIMESTAMP/* /var/www/html/
